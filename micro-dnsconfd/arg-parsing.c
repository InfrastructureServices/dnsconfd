...
static char doc[] = "Generator of resolv.conf and unbound configuration, parsing NM global config";
...
static struct argp_option options[] = {
    ...
    {"call-notify", 'c', 0, 0, "Call sd_notify if configuration generation was successful"},
    {0}};
