...
static unsigned char create_unbound_conf(GVariantDict *glob_dict, GString *unbound_config_string, FILE *log_file) {
...
GString *get_unbound_conf_string(GVariantDict *glob_dict, FILE* log_file) {
  ...
  if (create_unbound_conf(glob_dict, unbound_config_string, log_file)) {
