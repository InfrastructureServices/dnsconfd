...
class SystemManager:
    ...
    def __init__(self, resolv_conf_path: str, my_address: str):
        """ Maintain /etc/resolv.conf including backups

        :param resolv_conf_path: Path where resolv.conf is located
        :type resolv_conf_path: str
        :param my_address: Address of the caching service
        :type my_address: str
        """
        # File contents
        self._backup = None
