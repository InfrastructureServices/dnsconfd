...
rlJournalStart
    rlPhaseStartSetup
        ...
        rlRun "dnsmasq2_cid=\$(podman run -d --dns='none' --network dnsconfd_network2:ip=192.168.7.3 localhost/dnsconfd_utilities:latest dnsmasq_entry.sh --listen-address=192.168.7.3 --address=/second-address.test.com/192.168.7.3)" 0 "Starting first dnsmasq container"
    rlPhaseEnd
    ...
    rlPhaseStartCleanup
        rlRun "popd"
        rlRun "podman stop $dnsconfd_cid $dnsmasq1_cid $dnsmasq2_cid" 0 "Stopping containers"
