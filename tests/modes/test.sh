...
rlJournalStart
    ...
    rlPhaseStartTest
        ...
        # wait so NM does not interfere with our testing
        sleep 2
        rlRun "podman exec $dnsconfd_cid dnsconfd update --json '[{\"address\":\"192.168.6.3\"}, {\"address\":\"192.168.6.4\", \"interface\": \"eth0\", \"routing_domains\": [\".\", \"subdomain.example.com\"], \"search_domains\": [\"subdomain.example.com\"]}, {\"address\":\"192.168.6.5\", \"interface\": \"eth0\"}]' --mode backup" 0 "submit update"
        ...
        rlRun "podman exec $dnsconfd_cid dnsconfd update --json '[{\"address\":\"192.168.6.3\"}, {\"address\":\"192.168.6.4\", \"interface\": \"eth0\", \"routing_domains\": [\".\", \"subdomain.example.com\"], \"search_domains\": [\"subdomain.example.com\"]}, {\"address\":\"192.168.6.5\", \"interface\": \"eth0\"}]' --mode prefer" 0 "submit update"
        ...
        rlRun "podman exec $dnsconfd_cid dnsconfd update --json '[{\"address\":\"192.168.6.3\"}, {\"address\":\"192.168.6.4\", \"interface\": \"eth0\", \"routing_domains\": [\".\", \"subdomain.example.com\"], \"search_domains\": [\"subdomain.example.com\"]}, {\"address\":\"192.168.6.5\", \"interface\": \"eth0\"}]' --mode exclusive" 0 "submit update"
